...
# learning clevr-list
# python src/train_neumann_grad_scoring.py --dataset-type vilp --dataset delete --num-objects 3 --batch-size 256 --device 0 --epochs 20 --infer-step 4 --trial 5 --n-sample 5 --program-size 2  --max-var 6 --min-body-len 0 --pos-ratio 0.01 --neg-ratio 0.0
